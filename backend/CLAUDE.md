...
The monorepo includes automated CI/CD via GitHub Actions (`../.github/workflows/deploy-backend.yml`):
...
**Trigger:** Automatically runs on push to `main` branch, or can be manually triggered via `workflow_dispatch`.
...
See [TESTING_GUIDE.md](TESTING_GUIDE.md) for passwords and complete testing scenarios.
...
See [TESTING_GUIDE.md](TESTING_GUIDE.md#anonymous-sign-ins) for testing anonymous authentication.
